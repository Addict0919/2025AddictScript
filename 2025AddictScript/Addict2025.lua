...
addict.divider(addict.my_root(), "V0.09", {"addictversion"})
...
local Vehicle_Speed = addict.list(Vehicle_Events, "Vehicle Speed", {"vehiclespeed", ""})
    ...
    addict.toggle_loop(Vehicle_Speed,"Horn boost", {"hornboost"}, "Gives you the ability to speed up their car by pressing honking their horn or activating the siren. Will try fix it for other players soon.", function()
...
----------------------------------------------------------------------------------------------------------------------------------------
    ...
    addict.action(Crashing, "Elegant", {"elegant"}, "", function()
        addict.trigger_commands("crash" .. PLAYER.GET_PLAYER_NAME())
    end)

    addict.action(Crashing, "Vehicular Manslaughter", {"manslaughter"}, "", function()
        addict.trigger_commands("slaughter" .. PLAYER.GET_PLAYER_NAME())
    end)
