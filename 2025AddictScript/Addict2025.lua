...
addict.divider(addict.my_root(), "V1.0", {"addictversion"})
...
--------------------------------------------------------------------------------------------------------------------------------------------
local Fusion_Crash = addict.list(Crashing, "Fusion Crash", {"fusioncrash"}, "May crash some players nearby without mods. Causes XQ, X9 and prevented attachment loop crash.")
...
-- ===== Fusion Crash Loop =====
addict.toggle_loop(ROOT, "Fusion Crash", {}, "Chaos loop (attach, blast, explode, spawn).", function()
    ...
    -- spawn a prop if too few candidates
...
addict.toggle_loop(Crashing, "Invalid Task", {}, "Spawn animals and force them to fire weapons. Works on non modders.", function()
