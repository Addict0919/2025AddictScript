...
-- Delete broken vehicle parts nearby
    ...
    for _, obj in pairs(entities.get_all_objects_as_handles()) do
        if ENTITY.DOES_ENTITY_EXIST(obj) then
            ...
            if dist <= radius then
                ...
                -- Heuristic: if the object is a vehicle part (wheel, bumper, door)
                -- You can expand this list with known vehicle part props
                ...
                -- Delete the object if it's a vehicle part
...
-- Menu option to delete nearby broken vehicle parts
...
addict.divider(addict.my_root(), "V0.08", {"addictversion"})
---------------------------------------------------------------------------------------------------------------------------------------
